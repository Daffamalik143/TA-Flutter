...
class MappetugasPage extends StatefulWidget {
  const MappetugasPage({Key? key}) : super(key: key);

  @override
  State<MappetugasPage> createState() => _MappetugasPageState();
}

class _MappetugasPageState extends State<MappetugasPage> {
  ...
  void updateLocation(LatLng currentLocation) async {
    try {
      ...
      // Update the petugas's location in Firestore
