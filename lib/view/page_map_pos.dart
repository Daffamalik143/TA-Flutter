...
class MapPosPage extends StatefulWidget {
  const MapPosPage({Key? key}) : super(key: key);

  @override
  State<MapPosPage> createState() => _MapPosPageState();
}

class _MapPosPageState extends State<MapPosPage> {
  ...
  @override
  void initState() {
    _backgroundColor = Colors.white; // Assign a default background color
      ...
      if (!ispostMarkerAdded) {
        ...
        _controller?.addSymbol(
          SymbolOptions(
            ...
            iconImage: 'assets/custom_post.png',
            iconSize: 0.1,
          ),
        );
